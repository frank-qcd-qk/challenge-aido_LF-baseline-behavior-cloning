...
class FrankNet:
    ...
    @staticmethod
    def build_branch(inputs=(150, 200, 3)):
        # ? Input Normalization
        ...
        x = Dense(2, kernel_initializer='normal', name="Prediction")(x)
    ...
    def build(width=150, height=200):
        ...
        prediction = FrankNet.build_branch(inputs)

        model = tf.keras.Model(inputs=inputs, outputs=prediction, name="FrankNet")
